...
public class MoverAvatarIzquierda extends Operador{

	public MoverAvatarIzquierda(int x, int y) {
		
		super("MoverAvatarIzquierda", x, y);
		
		ArrayList<Literal> pre = new ArrayList<>();
		pre.add(new Literal("AvatarEnPosicion", x, y));   
		pre.add(new Literal("EspacioLibre", x-1, y));
		super.setPre(pre);
